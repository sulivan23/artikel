		...
		$.extend(true, $.summernote.lang, {
			'en-US': {
				imageAttributes: {
					...
					widthLabel : "Width",
					heightLabel : "Heght",
					imageLockLabel : "Lock (klik button gembok jika anda ingin resize gambar)",
					tooltip: 'Edit Image',

@extends('layouts.table_layouts',['title' => 'Verifikasi Artikel'])
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Verifikasi Artikel</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Data Verifikasi Artikel</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">   
